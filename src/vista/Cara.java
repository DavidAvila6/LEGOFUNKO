...
public class Cara extends javax.swing.JFrame  {
     Partes f = Factoria.getParte("cara");
    ...
    public Cara() {
         ...
         ImageIcon ico = new ImageIcon(getClass().getResource("/imgcara/cara1.png"));
         puente.controladorico(PB1,ico);
        
         ico = new ImageIcon(getClass().getResource("/imgcara/cara2.png"));
         puente.controladorico(PB2,ico);
        
         ico = new ImageIcon(getClass().getResource("/imgcara/cara3.png"));
         puente.controladorico(PB3,ico);
         
         ico = new ImageIcon(getClass().getResource("/imgcara/cara4.png"));
         puente.controladorico(PB4,ico);
         
         ico = new ImageIcon(getClass().getResource("/imgcara/cara5.png"));
         puente.controladorico(PB5,ico);
         
         ico = new ImageIcon(getClass().getResource("/imgcara/cara6.png"));
         puente.controladorico(PB6,ico);
        
        
         puente.controladorfon(jPanel1,"/img/fca.jpg");
